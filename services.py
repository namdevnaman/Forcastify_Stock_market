...
def plot_multiple_data(forecasts, stock_names):
    fig = go.Figure()
    for forecast, stock in zip(forecasts, stock_names):
        fig.add_trace(go.Scatter(x=forecast['ds'], y=forecast['yhat'], name=stock))
